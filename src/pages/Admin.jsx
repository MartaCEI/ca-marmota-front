...
const Admin = () => {
    ...
    const cancelBooking = async (bookingId) => {
        try {
            ...
            if (!response.ok) throw new Error('Error al cancelar booking');
            getBookings();
        } catch (error) {
            console.error('Error:', error);
        }
    ...
    return (
        <>
            ...
            <p className="mb-4"><strong>Lista de bookings</strong></p>
            ...
            <p className="mb-4"><strong>Bookings cancelados</strong></p>
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full bg-white border border-gray-200">
                    ...
                    <tbody>
                        ...
                        cancelados.map(({ roomId, userId, checkIn, checkOut, totalAmount, totalNights, transactionId, status }) => (
                            <tr key={transactionId} className="border-b hover:bg-gray-50">
                                <td className="py-2 px-4 border-r">{roomId.roomName}</td>
                                <td className="py-2 px-4 border-r">{formatDate(checkIn)}</td>
                                <td className="py-2 px-4">{formatDate(checkOut)}</td>
